...
/// Struct that represents a ToXDMExchangeRateUpdateEvent
#[derive(Debug, Serialize, Deserialize)]
pub struct ToXDMExchangeRateUpdateEvent {
    currency_code: Identifier,
    new_to_xdm_exchange_rate: u64,
}

impl ToXDMExchangeRateUpdateEvent {
    ...
    pub fn new_to_xdm_exchange_rate(&self) -> f32 {
        let unrounded = (self.new_to_xdm_exchange_rate as f32) / 2f32.powf(32f32);
...
impl MoveResource for ToXDMExchangeRateUpdateEvent {
    const MODULE_NAME: &'static str = DIEM_MODULE_NAME;
    const STRUCT_NAME: &'static str = "ToXDMExchangeRateUpdateEvent";
}
