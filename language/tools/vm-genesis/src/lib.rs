...
pub fn encode_genesis_change_set(
    ...
    let xdm_ty = TypeTag::Struct(StructTag {
        address: *account_config::XDM_MODULE.address(),
        module: account_config::XDM_MODULE.name().to_owned(),
        name: account_config::XDM_STRUCT_NAME.to_owned(),
        type_params: vec![],
    });
