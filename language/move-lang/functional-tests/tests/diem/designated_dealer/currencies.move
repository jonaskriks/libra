...
script {
    ...
    fun main(account: &signer) {
        ...
        assert(DiemAccount::accepts_currency<Coin1>(0x2), 0);
        assert(!DiemAccount::accepts_currency<XDM>(0x2), 2);
        ...
        assert(DiemAccount::accepts_currency<Coin1>(0x3), 3);
        assert(DiemAccount::accepts_currency<XDM>(0x3), 5);
    }
}
