...
script {
    ...
    fun main(tc_account: &signer) {
        AccountLimits::update_limits_definition<XDM>(tc_account, CoreAddresses::DIEM_ROOT_ADDRESS(), 2, 2, 0, 0);
    }
}
...
script {
    ...
    use 0x1::XDM::XDM;
    fun main(tc_account: &signer) {
        AccountLimits::update_limits_definition<XDM>(tc_account, CoreAddresses::DIEM_ROOT_ADDRESS(), 1000, 1000, 1000, 0);
    }
}
