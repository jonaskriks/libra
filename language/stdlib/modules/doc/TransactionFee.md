...
-  [Function `burn_fees`](#0x1_TransactionFee_burn_fees)
    -  [Specification of the case where burn type is XDM.](#@Specification_of_the_case_where_burn_type_is_XDM._1)
    -  [Specification of the case where burn type is not XDM.](#@Specification_of_the_case_where_burn_type_is_not_XDM._2)
...
If the <code>CoinType</code> is XDM, it unpacks the coin and preburns the
underlying fiat.
...
<pre><code><b>public</b> <b>fun</b> <a href="TransactionFee.md#0x1_TransactionFee_burn_fees">burn_fees</a>&lt;CoinType&gt;(
    ...
    <b>if</b> (<a href="XDM.md#0x1_XDM_is_xdm">XDM::is_xdm</a>&lt;CoinType&gt;()) {
        // TODO: Once the composition of <a href="XDM.md#0x1_XDM">XDM</a> is determined fill this in <b>to</b>
        // <b>unpack</b> and burn the backing coins of the <a href="XDM.md#0x1_XDM">XDM</a> coin.
...
<b>aborts_if</b> !<a href="TransactionFee.md#0x1_TransactionFee_is_coin_initialized">is_coin_initialized</a>&lt;CoinType&gt;() <b>with</b> <a href="Errors.md#0x1_Errors_NOT_PUBLISHED">Errors::NOT_PUBLISHED</a>;
<b>include</b> <b>if</b> (<a href="XDM.md#0x1_XDM_spec_is_xdm">XDM::spec_is_xdm</a>&lt;CoinType&gt;()) <a href="TransactionFee.md#0x1_TransactionFee_BurnFeesXDM">BurnFeesXDM</a> <b>else</b> <a href="TransactionFee.md#0x1_TransactionFee_BurnFeesNotXDM">BurnFeesNotXDM</a>&lt;CoinType&gt;;
</code></pre>
...
STUB: To be filled in at a later date once the makeup of the XDM has been determined.


<a name="@Specification_of_the_case_where_burn_type_is_XDM._1"></a>

### Specification of the case where burn type is XDM.



<a name="0x1_TransactionFee_BurnFeesXDM"></a>


<pre><code><b>schema</b> <a href="TransactionFee.md#0x1_TransactionFee_BurnFeesXDM">BurnFeesXDM</a> {
    tc_account: signer;
...
<a name="@Specification_of_the_case_where_burn_type_is_not_XDM._2"></a>

### Specification of the case where burn type is not XDM.



<a name="0x1_TransactionFee_BurnFeesNotXDM"></a>


<pre><code><b>schema</b> <a href="TransactionFee.md#0x1_TransactionFee_BurnFeesNotXDM">BurnFeesNotXDM</a>&lt;CoinType&gt; {
    tc_account: signer;
}
</code></pre>
