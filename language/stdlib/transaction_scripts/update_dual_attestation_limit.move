...
/// Updates the `micro_xdm_limit` field of the `DualAttestation::Limit` resource published under
/// `0xA550C18`. The amount is set in micro-XDM.
///
/// # Parameters
...
/// | `new_micro_xdm_limit` | `u64`     | The new dual attestation limit to be used on-chain.                                                       |
///
...
fun update_dual_attestation_limit(
    ...
    DualAttestation::set_microdiem_limit(tc_account, new_micro_xdm_limit);
}
}
